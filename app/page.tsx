...
export default async function Home() {
  ...
  const { data, error } = await supabase
    .from("products")
    .select("id,name,slug,description,price,image_url,ingredients,is_available,created_at")
  ...
  // Shared by OrderForm (id/name/price/isAvailable) and the cart drawer
  // (which also wants imageUrl for its line-item thumbnails). One
  // server-side read, joined fresh on every render - never cached prices.
